...
class TranscribeServiceTest {
    ...
    class ErrorHandlingAndEdgeCases {
        ...
        @Test
        @DisplayName("transcribe() - Should handle IllegalArgumentException from audioTranscriptionModel")
        void transcribe_ShouldHandleIllegalArgumentExceptionFromModel() throws Exception {
            // Arrange
            when(audioTranscriptionModel.call(any(AudioTranscriptionPrompt.class)))
    ...
    class CreateDefaultOptionsMethod {
        ...
        void createDefaultOptions_ShouldCreateOptionsWithCorrectDefaults() throws Exception {
            ...
            // Since the method is private, we test it indirectly through the transcribe method
            ...
            verify(audioTranscriptionModel).call(argThat(prompt -> {
                assertNotNull(prompt.getOptions());
                // The options should be created with default values as specified in the constants
                return true;
            }));
        }
    }
